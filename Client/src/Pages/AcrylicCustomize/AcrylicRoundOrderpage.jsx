              ...
              <div className="p-8 flex items-center justify-center">
                <div className="flex flex-col items-center justify-center space-y-6">
                  <div className="relative w-full max-w-md mx-auto">
                    <div
                      className="relative mx-auto rounded-full bg-primary overflow-hidden shadow-2xl transition-all duration-500"
                      style={{
                      ...
                      <button
                        ...
                        className={`px-4 py-3 rounded-xl border-2 text-sm font-medium transition-all duration-200 ${
                          selectedSize?.label === sizeObj.label
                            ...
                            : "bg-white text-secondary border-neutral-300 hover:border-cyan-400 hover:shadow-md"
                        }`}
                      >
                ...
                <div className="space-y-4 pt-4 border-t border-neutral-200">
                  <div className="flex items-center gap-4">
                    ...
                    <input
                      ...
                      className="w-24 px-4 py-2 border-2 border-neutral-300 rounded-lg focus:outline-cyan-600 focus:ring-2 focus:ring-cyan-200 font-semibold text-center"
                    />
                  </div>
