      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
            Select your preferred size and thickness to see your custom
            backlight frame preview
          </p>
        </div>
                  ...
                  <div className="relative w-full max-w-lg mx-auto">
                    <div
                      className={`relative mx-auto bg-primary rounded-2xl overflow-hidden shadow-2xl transition-all duration-500 mask-portrait ${
                        lightOn
                          ? "ring-4 ring-yellow-400 shadow-yellow-300"
                          : ""
                      }`}
                      style={{
                    ...
                    >
                      <Lightbulb
                        className={`w-5 h-5 ${lightOn ? "animate-pulse" : ""}`}
                      />
