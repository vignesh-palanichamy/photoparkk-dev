      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
            Upload your favorite photo and see it glow in a beautiful backlit
            landscape frame
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="p-6">
              {!photoData ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative w-full aspect-[4/3] bg-white rounded-xl overflow-hidden border-2 border-neutral-200 shadow-inner">
                    <img
                      src={photoData.url}
          ...
          <div
            className={`rounded-2xl shadow-xl overflow-hidden border border-neutral-200 transition-colors ${
              lightOn ? "bg-gradient-to-br from-gray-900 to-black" : "bg-white"
            }`}
          >
            <div
              className={`px-6 py-4 transition-colors ${
                lightOn ? "bg-primary" : "bg-primary"
              }`}
            >
            ...
            <div className="p-8 flex flex-col items-center justify-center">
              <div className="relative w-full max-w-md mb-6">
                {/* Light Toggle */}
                <div
                  className={`flex items-center justify-center gap-3 mb-6 p-4 rounded-xl border ${
                    lightOn
                ...
                >
                  <Lightbulb
                    className={`w-5 h-5 ${
                      lightOn ? "text-warning" : "text-neutral-400"
                    }`}
                  />
                  <label
                    htmlFor="lightToggle"
                ...
                {photoData && (
                  <div
                    className={`absolute -bottom-4 left-1/2 transform -translate-x-1/2 px-4 py-2 rounded-full shadow-lg border ${
                      lightOn
                  ...
                  >
                    <span className="text-sm font-medium flex items-center gap-2">
                      <Lightbulb
                        className={`w-4 h-4 ${
                          lightOn ? "text-secondary" : "text-neutral-500"
                        }`}
                      />
                      Backlight Frame
                    </span>
              ...
              {photoData && (
                <div className="mt-6 text-center w-full">
                  ...
                  >
                    ...
                    Toggle the light to preview and click "View Full Preview" to
                    continue.
                  </p>
                </div>
              )}
