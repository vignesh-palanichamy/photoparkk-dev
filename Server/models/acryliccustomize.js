...
const acrylicCustomizeSchema = new mongoose.Schema(
  {
    title: {
      type: String,
      required: true,
...
const AcrylicCustomizedata = mongoose.model("AcrylicCustomizedata",acrylicCustomizeSchema);

export default AcrylicCustomizedata;
